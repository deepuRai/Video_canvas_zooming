...
function drawImgeC() {
  ...
  if(sessionStorage.getItem("drawRectangle")=='1' && sessionStorage.getItem("drawRectangleW")!='0'){
      
    
    let frameData = ctx.getImageData(sessionStorage.getItem("drawRectangleX"), sessionStorage.getItem("drawRectangleY"), sessionStorage.getItem("drawRectangleW"), sessionStorage.getItem("drawRectangleH"));
    var newData = resizeImageData(frameData,370,220)
...
async function resizeImageData(imageData, width, height) {
  ...
  var canvas11 = document.querySelector("#zoomData");
  canvas11.width = resizeWidth
  canvas11.height = resizeHeight
